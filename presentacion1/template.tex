...
\begin{frame}
  ...
  %  \column{0.5\textwidth}
  \justifying
  \scriptsize Dada una región tridimensional desconocida y \textit{n} VANTS, el propósito es la propuesta de puntos de interés que implique una asignación de trayectoria para cada VANT. En el camino se descubrirán nuevos puntos de interés, haciendo de esta una lista de tareas dinámicas.\\
  El problema consite en asignar las tareas de exploración (puntos de visión) para conocer la región de interés garantizando que toda la región sea explorada, así como la evasión de obstáculos.\\
  \bigskip % Vertical whitespace
