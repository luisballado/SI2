  ...
  \begin{table*}[htbp]
    ...
    \scalebox{1.20}{
      \begin{tabular}{ | p{3.1cm} | p{1.6cm} | p{2.5cm} | p{3cm} | p{3.1cm} | p{0.8cm} | p{0.9cm} | p{0.7cm} | }
        ...
        \hline
        %--------------------------
        \tiny \cellcolor{gray!20}\cite{CINVES2015}[\citenum{CINVES2015}]&
        \tiny \cellcolor{gray!20}N/A&
        \tiny \cellcolor{gray!20}N/A&
        \tiny \cellcolor{gray!20}N/A&
        \tiny \cellcolor{gray!20}Ley de Control&
