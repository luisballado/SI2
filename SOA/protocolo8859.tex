...
\begin{abstract}
  ...
  El enfoque de este trabajo es la propuesta de una arquitectura descentralizada de software capaz de coordinar m\'{u}ltiples veh\'{i}culos a\'{e}reos no tripulados con habilidades para la exploraci\'{o}n, generaci\'{o}n de mapas y planificaci\'{o}n de rutas para explorar eficientemente un \'{a}rea de inter\'{e}s.\\
  \vspace{1cm}
  %\medskip \\
...
En exploración, el objetivo es construir un mapa de un espacio desconocido. La exploración es una tarea fundamental en robótica.\\

La \textbf{representación del ambiente (mapa)} es usada para describir el espacio que el robot percibe. Basados en esa descripción, un algoritmo de planificación de trayectorias decidirá donde moverse. Mientras que la representación del ambiente es usada para representar el espacio que el robot percibe.
...
%La planificaciÃƒÂƒÃ‚ÂƒÃƒÂ‚Ã‚Â³n de trayectorias tambiÃƒÂƒÃ‚ÂƒÃƒÂ‚Ã‚Â©n ha abordado la problemÃƒÂƒÃ‚ÂƒÃƒÂ‚Ã‚Â¡tica de la planificaciÃƒÂƒÃ‚ÂƒÃƒÂ‚Ã‚Â³n de mÃƒÂƒÃ‚ÂƒÃƒÂ‚Ã‚Âºltiples robots. Se han desarrollado algoritmos que permiten a los robots colaborar y coordinarse para evitar colisiones y mejorar la eficiencia en sus tareas. Estos enfoques utilizan tÃƒÂƒÃ‚ÂƒÃƒÂ‚Ã‚Â©cnicas de planificaciÃƒÂƒÃ‚ÂƒÃƒÂ‚Ã‚Â³n centralizada o descentralizada, y pueden basarse en mÃƒÂƒÃ‚ÂƒÃƒÂ‚Ã‚Â©todos de bÃƒÂƒÃ‚ÂƒÃƒÂ‚Ã‚Âºsqueda o algoritmos de optimizaciÃƒÂƒÃ‚ÂƒÃƒÂ‚Ã‚Â³n multiobjetivo.\\
...
%La asignaciÃƒÂƒÃ‚ÂƒÃƒÂ‚Ã‚Â³n de tareas es otro aspecto crucial en la colaboraciÃƒÂƒÃ‚ÂƒÃƒÂ‚Ã‚Â³n de mÃƒÂƒÃ‚ÂƒÃƒÂ‚Ã‚Âºltiples VANTs. Los VANTs deben ser capaces de dividir y asignar las tareas de manera ÃƒÂƒÃ‚ÂƒÃƒÂ‚Ã‚Â³ptima, considerando factores como la capacidad de carga, la distancia a las ubicaciones objetivo y los recursos disponibles. Se han propuesto diferentes estrategias de asignaciÃƒÂƒÃ‚ÂƒÃƒÂ‚Ã‚Â³n de tareas, como algoritmos basados en la teorÃƒÂƒÃ‚ÂƒÃƒÂ‚Ã‚Â­a de grafos y enfoques basados en tÃƒÂƒÃ‚ÂƒÃƒÂ‚Ã‚Â©cnicas de optimizaciÃƒÂƒÃ‚ÂƒÃƒÂ‚Ã‚Â³n.\\
...
Buscando acelerar la exploración, el robot debe percibir el ambiente desconocido lo más rápido posible. Existen dos principales técnicas en la literatura.
...
\begin{landscape}
  \begin{table*}[htbp]
    ...
    \vspace{0.5cm}
    \scalebox{1.20}{
      \begin{tabular}{ | p{3.1cm} | p{1.6cm} | p{2.5cm} | p{3cm} | p{3.1cm} | p{0.8cm} | p{0.9cm} | p{0.7cm} | }
        \hline    
        \tiny REFERENCIA&
        \tiny APLICACIÓN&
        \tiny GENERACION MAPA&
